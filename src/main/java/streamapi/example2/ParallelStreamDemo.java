...
public class ParallelStreamDemo {
    public static void main(String[] args) {
        ...
        //eList.forEach(x-> System.out.println(x.getName()));
        ...
        eList.stream().forEach(x-> System.out.println(x.getName()));

        System.out.println("Parallel Stream");
        eList.parallelStream().forEach(x-> System.out.println(x.getName()));
    }
